...
namespace Abp.SampleApp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("SampleApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "SampleApp", DisplayName = "SampleApp API", Resources = { "SampleApp" }
            });
        }
    }
